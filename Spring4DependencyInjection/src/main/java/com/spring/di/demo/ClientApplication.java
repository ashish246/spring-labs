 ...
 * 
 * getBean(Class) method returns the Component object and uses the configuration
 * for autowiring the objects. Context objects are resource intensive, so we
 * should close them when we are done with it.
 * 
